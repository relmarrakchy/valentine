...
const LetterEnvelope = forwardRef<HTMLElement, LetterEnvelopeProps>(function LetterEnvelope(
  ...
  return (
    <section ref={ref} className="min-h-screen flex items-center justify-center px-4 py-24">
      <div
        ref={containerRef}
      ...
      >
        ...
        <motion.div
          ...
          animate={{
            height: isOpen ? "auto" : "420px",
          }}
          transition={{ duration: 0.6, ease: "easeInOut" }}
          style={{ minHeight: isOpen ? "auto" : "420px" }}
        >
          {/* ─── Envelope flap (triangle) ─── */}
          <motion.div
            className={`absolute top-0 left-0 right-0 h-[210px] bg-gradient-to-b ${envFlap} origin-top z-20 rounded-t-lg`}
            style={{
          ...
          <AnimatePresence>
            {!isOpen && (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-full ${sealBg} border-4 ${sealBorder} flex items-center justify-center shadow-lg`}
                >
                  <svg
                    width="26"
                    height="24"
          ...
          <AnimatePresence>
            {!isOpen && (
              <motion.p
                className={`absolute bottom-8 left-0 right-0 text-center text-xs tracking-[0.3em] uppercase ${accentText}/60`}
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                <div className="relative rounded-lg overflow-hidden flex min-h-[420px]">
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage: `repeating-linear-gradient(
                          transparent,
                          transparent 35px,
                          ${isLove ? "rgba(219, 39, 119, 0.08)" : "rgba(217, 119, 6, 0.08)"} 35px,
                          ${isLove ? "rgba(219, 39, 119, 0.08)" : "rgba(217, 119, 6, 0.08)"} 36px
                        )`,
                  ...
                  <div
                    ...
                    style={{
                      ...
                      backgroundImage: `repeating-linear-gradient(
                        transparent,
                        transparent 35px,
                        ${isLove ? "rgba(219, 39, 119, 0.06)" : "rgba(217, 119, 6, 0.06)"} 35px,
                        ${isLove ? "rgba(219, 39, 119, 0.06)" : "rgba(217, 119, 6, 0.06)"} 36px
                      )`,
                      backgroundPosition: "0 42px",
                  ...
                  >
                    {/* Content */}
                    <div className="relative px-10 py-16 md:px-14 md:py-20">
                      <motion.p
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.8, duration: 0.6 }}
                        className="text-2xl md:text-3xl font-script text-black mb-8 leading-relaxed relative top-1 left-3"
                      >
                        {greeting}
                      </motion.p>
                      ...
                      <motion.p
                        ...
                        className="text-lg md:text-xl leading-[2.2] w-95 text-black font-script relative left-10 top-10"
                      >
                        {letterBody}
                      </motion.p>
                      ...
                      >
                        <p className="text-xl md:text-2xl font-script text-black leading-relaxed relative top-25">
                          {closing}
                        </p>
                      </motion.div>
                    </div>
